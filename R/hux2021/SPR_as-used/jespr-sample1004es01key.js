...
/* 11353. dieses design der items wurde von uns für das experiment benutzt. es haben sich schwierigkeiten in der auswertung ergeben, weil die region of interest, die die targetposition = 0 im datensatz markiert, erst nach beginn des experiments im design mit {ROI} markiert wurde und die position von dashes | zur abtrennung der phrasen ebenfalls erst nach beginn korrigiert wurden. */
var jesprExperimentDesignForKey = { //actuel 11284///// items in: 2,5,6,10,11,12,18,26
    "title": "GROUP 1: self paced essai",
    "investigators":[ {
        "primary": "ST, VE, LSH, QU"
    }, {
        "other": ""
    }],
    "font-name": "courier",
  ...
  "options": [
                        ...
                        },
                        {
                                        ...
                                        "item": {
                                            "id": "EM17",
                                            "tags": [ "RUB", "17EM" ],
                                            "string": "Esra wollte ihren ehemaligen Arbeitgeber vor Gericht in Frikassee verwandeln.| Doch sie wusste nicht, dass die Firma sich von einem der gefährlichsten Raubtiere vertreten ließ.| Keines seiner Opfer war je von ihm verschont worden.| Der Anwalt war ein Hai.",
                        ...
                        },
                        {
                                    ...
                                    
                                       {
                                        "item": {
                                            "id": "EM19",
                                            "tags": [ "RUB", "19EM" ],
                                            "string": "Hegels Vorstellung vom dialektischen Idealismus war eine Kopfgeburt gewesen.| Generationen von PhilosophInnen bekamen Kopfschmerzen von einem derartig schwindelerregenden Konstrukt.| Zum Glück wurde Hegel endlich durch Marx| vom Kopf auf die Füße gestellt.",
                        ...
                        },
                        {
                                    ...
                                    
                                    {
                                        "item": {
                                            "id": "SM14",
                                            "tags": [ "RUB", "14SM" ],
                                            "string": "Lea hatte sich angewöhnt,| von ihrem Mann Jakob nur noch als dem blöden Schäfer zu sprechen,| seit er begonnen hatte,| die schwarzen Schafe der Familie ihres Vaters| und die weißen Schafe der Familie ihres Onkels| gemeinsam inmitten eines Birkenhains zu tränken –| denn diese Schafe brachten nach ihrer Meinung nur minderwertige| schwarzweiß gescheckte Lämmer zur Welt.| Sie warf ihm vor, das Gold der Familie zu versilbern.",
                        ...
                        },
                        {
                                    ...
                                    
                                     {
                                        "item": {
                                            "id": "SM26",
                                            "tags": [ "RUB", "26SM" ],
                                            "string": "Es schien, als könnte Erna sich alles merken.| Besonders in den Naturwissenschaften hatte sie ein beachtliches Wissen angesammelt.| {Erna war eine wandelnde Bibliothek.}| Wenn es darauf ankam, konnte sie immer diejenige Information abrufen,| die im Moment entscheidend war.| Immerhin hatte sie dort sämtliche Einträge von ‚A‘ wie ‚Amalgam‘ bis ‚Z‘ wie ‚Zentrifugalkraft‘ gelagert.",
                       /*                         "prompt": "Haben Sie den Text aufmerksam gelesen?",
                                              "options": [
                                          {
                                               "string": "Ja",
                        ...
                        },
                        {
                                    ...
                                    },
                                      {
                                        "item": {
                                            "id": "item55",
                                            "tags": [ "RUB", "1LC002" ],
                                            "string": "Martha bereute, die streunende Katze nach Hause mitgebracht zu haben,| die sie im Park gefunden hatte.| In den letzten zwei Tagen| hatte diese die Vorhänge des Wohnzimmers| und die vier Beine des Küchentischs zerstört.| Sie hatte scharfe Klauen.| Martha befürchtete,| es wäre schon zu spät dafür,| eine Katze in diesem Alter aufzunehmen.",
