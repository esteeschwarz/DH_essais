...
```
Q: [ANNIS github](https://github.com/korpling/ANNIS/main/src/test/resources/org/corpus_tools/annis/gui/visualizers/component/tree/example_constituent_tree/rootCorpus/subCorpus1/doc1.salt)
hhh
### issues:
- to date at least the SES transcripts are available in plain text
- EKMAUS material has to be OCR converted from .pdf to text
- 
### material:
sample transcript of SES corpus:
<iframe src="SES_ELL_Gca_f_8.txt">
