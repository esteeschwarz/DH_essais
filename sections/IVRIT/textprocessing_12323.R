...
#lines_df[[9]]
pb<-"----pagebreak----"
text_cpt<-c(lines_df[[1]],pb,lines_df[[2]],pb,lines_df[[3]],pb,lines_df[[4]],pb,lines_df[[5]],pb,lines_df[[6]],pb,lines_df[[7]],pb,lines_df[[8]],pb,lines_df[[9]])
text_cpt
regx1<-"61"
regx1<-"64"
regx1<-"66"
...
textm<-gsub(regx1,repl1,text_cpt)
textm<-gsub(regx1,repl1,textm)
textm
