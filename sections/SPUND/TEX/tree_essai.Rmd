...
TODO not working: figure captions, inclusion of external .tex configuration
...
%\end{figure}
%\end{forest}
\caption{fenced forest with outside command declaration, pittner notation}
\end{figure}
