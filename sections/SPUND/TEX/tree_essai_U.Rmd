...
####<Pos:dependencies    
    extra_dependencies: ["float","pgf","forest","caption","pict2e","lipsum","amsthm","tikz"]
#header-includes: '\usepackage{cleveref}' #nope
...
\vbox{%
\begin{Sch}[try own schema caption: long sentences grafix]%\label{figure03}
\lingforest{40}{%
[S, dashed, tier=1
	[AdvP, dashed
	[links, dashed]]
...
%\caption{lingforest with long sentences}

\end{Sch} %cannot be in environment {figure}, has to be {Sch}, but then no \caption possible
}
%last error: LaTeX Error: Not in outer par mode.
%Package forest Error: Circular tier hierarchy (tier 2).
%verlängerung der zweige without tier declaration possible
