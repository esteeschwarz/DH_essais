...
\CommentTok{\#latex\_dependency("cleveref") \#doesnt \textbackslash{}usepackage\{\} from here}
\CommentTok{\#pandoc\_include\_args("{-}{-}template=calibration.tex")}
\CommentTok{\#latex\_dependency\_tikz("cleveref") \#is installed}
...
\CommentTok{\#tlmgr\_install(\textquotesingle{}cleveref\textquotesingle{})}
...
\CommentTok{\#pandoc\_include\_args(in\_header  = "calibration.tex")}
