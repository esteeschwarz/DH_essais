...
output:
  bookdown::pdf_document2:
    extra_dependencies: ["float","pgf","forest"]
...
# tinytex::tlmgr ("repository add http://pgf-tikz.github.io/pgf/tlnet pgf-development")
...
pandoc_include_args(before_body = "calibration.tex")
...
<!-- oben funktioniert, unten findet nicht das environment "Bsp"-->
<!-- $$latex -->
